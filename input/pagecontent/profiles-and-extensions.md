...
#### Bundle
- [傳染病通報-Bundle NIDRS](StructureDefinition-Bundle-NIDRS.html)
...
#### Patient
- [個案資料-Patient NIDRS](StructureDefinition-Patient-NIDRS.html)

#### RelatedPerson
- [個案生母資料-RelatedPerson NIDRS](StructureDefinition-RelatedPerson-NIDRS.html)

#### Encounter
- [病患動向與通報疾病-Encounter NIDRS](StructureDefinition-Encounter-NIDRS.html)

#### Condition
- [通報疾病(簡單病)-Condition NIDRS](StructureDefinition-Condition-NIDRS.html)
...
- [DeathReasonB](StructureDefinition-extension-death-reason-b.html)：死亡原因乙
...
- [PhbReceivedDay](StructureDefinition-extension-phbReceivedDay.html)：衛生局收到日
- [ResidenceType](StructureDefinition-extension-residence-type.html)：非本國籍居民身份